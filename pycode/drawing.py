...
class Drawing:
    def __init__(self, sc, sc_map, player, clock):
        ...
        self.font_timer = pygame.font.Font('font/font.ttf', 120)
    ...
    def mini_map(self, player):
        ...
        pygame.draw.line(self.sc_map, RED, (map_x, map_y), (map_x + 12 * math.cos(player.angle),
                                                 map_y + 12 * math.sin(player.angle)), 2)
        pygame.draw.circle(self.sc_map, RED, (int(map_x), int(map_y)), 5)
        for x, y in mini_map:
            pygame.draw.rect(self.sc_map, RED, (x, y, MAP_TILE, MAP_TILE), 1)
    ...
    def win(self):
        render_win = self.font_win.render('YOU WIN!!!', 1, (randrange(40, 120), 0, 0))
        print(time.time())
        render = self.font_timer.render(f'{str((time.time() - self.c) // 1)} сек', 1, (randrange(40, 120), 10, 10))
        rect = pygame.Rect(0, 0, 1000, 300)
        rect.center = HALF_WIDTH, HALF_HEIGHT
        pygame.draw.rect(self.sc, BLACK, rect, border_radius=50)
        self.sc.blit(render, (rect.centerx - 200, rect.centery - 0))
        self.sc.blit(render_win, (rect.centerx - 430, rect.centery - 140))
        pygame.display.flip()
        self.clock.tick(15)
        return False
    ...
    def menu(self):
        ...
        label_font = pygame.font.Font('font/font1.otf', 220)
        ...
        while self.menu_trigger:
            ...
            color = randrange(40)
            label = label_font.render('ПОЧТИ ДУМ', 1, (color, color, color))
            self.sc.blit(label, (120, -10))
